...
int main(int argc, char* argv[]) {
	...
	strcpy(instruction_test, "lui 1, 15");
	printf("%s\n",instruction_test);
	...
	strcpy(instruction_test, "rotr 3, 1, 2");
	printf("%s\n",instruction_test);
	rotrEmul(instruction_test, memoire, registres);
	...
	strcpy(instruction_test, "sll 3, 1, 2");
	printf("%s\n",instruction_test);
	sllEmul(instruction_test, memoire, registres);
	...
	strcpy(instruction_test, "srl 3, 1, 2");
	printf("%s\n",instruction_test);
	srlEmul(instruction_test, memoire, registres);
	...
	strcpy(instruction_test, "slt 3, 2, 1");
	printf("%s\n",instruction_test);
	sltEmul(instruction_test, memoire, registres);
